...
This report walks the locally vendored ECMA-376 Strict, Transitional, and OPC XSD schemas under `references/raw/` and the 3,887 public declarations under `src/ecma376/`.
